...
class HTMLParser(BaseParser):
    ...
    def get_keyword(self, html):
        ...
        hidden_name_list = re.findall(r'type="hidden".*?name="(.*?)".*?(?:value="(.*?)"|>)', html_content) \
            + re.findall(r'name="(.*?)".*?type="hidden".*?(?:value="(.*?)"|>)', html_content) \
                + turn_tuple_order(re.findall(r'type="hidden".*?(?:value="(.*?)").*?name="(.*?)"', html_content))
        hidden_id_list = re.findall(r'type="hidden".*?id="(.*?)".*?(?:value="(.*?)"|>)', html_content) \
            + re.findall(r'id="(.*?)".*?type="hidden".*?(?:value="(.*?)"|>)', html_content) \
                + turn_tuple_order(re.findall(r'type="hidden".*?(?:value="(.*?)").*?id="(.*?)"', html_content))
        annotated_name_list = re.findall(r'<!--.*?name="(.*?)".*?(?:value="(.*?)"|>)', html_content, re.S)
        annotated_name_list2 = turn_tuple_order(re.findall(r'<!--.*?(?:value="(.*?)").*?name="(.*?)"', html_content, re.S))
        annotated_id_list = re.findall(r'<!--.*?id="(.*?)".*?(?:value="(.*?)"|>)', html_content, re.S)
        annotated_id_list2 = turn_tuple_order(re.findall(r'<!--.*?(?:value="(.*?)").*?id="(.*?)"', html_content, re.S))
        ...
        form_list = re.findall(form_pattern, html_content, re.S)
        for form in form_list:
            action_set = set(re.findall(action_pattern,form,re.S))
            name_value_pair_list = re.findall(name_value_pattern,form,re.S) \
                + turn_tuple_order(re.findall(name_value_pattern2,form,re.S))
            id_value_pair_list = re.findall(id_value_pattern,form,re.S) \
                + turn_tuple_order(re.findall(id_value_pattern2,form,re.S))
            method_set = set(re.findall(method_pattern,form,re.S))
