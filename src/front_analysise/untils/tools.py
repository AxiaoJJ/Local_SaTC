...
from front_analysise.untils.config import FROM_BIN_ADD, UPNP_ANALYSISE, SIM_RATIO
...
class AnalysisBinary(object):
    ...
    def _similarity(self, str1, str2):
        ...
        if SequenceMatcher(None,str1,str2).quick_ratio() > sim_ratio_upper:
            return SequenceMatcher(None,str1,str2).ratio() > sim_ratio
        else:
            return False
